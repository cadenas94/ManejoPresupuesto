...
namespace ManejoPresupuesto.Servicios
{
    public interface IServicioReportes
    {
        ...
        Task<ReporteTransaccionesDetalladas> ReporteTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag);
    }
    public class ServicioReportes: IServicioReportes
    {
        ...
        public async Task<ReporteTransaccionesDetalladas> ReporteTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag)
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicioYFin(mes, año);
