...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController: Controller
    {
        ...
        public async Task<IActionResult>  Index(int mes, int año)
        {
            ...
            var modelo = await servicioReportes.ReporteTransaccionesDetalladas(usuarioId, mes, año, ViewBag);
            return View(modelo);
        }
        ...
        public async Task<IActionResult> Mensual(int año)
        {
            ...
            for (int mes = 1; mes <= 12; mes++)
            {
                ...
                if(transaccion is null)
                {
                    ...
                    {
                        Mes= mes,
                        FechaRefencia= fechaReferencia
                    });
                }
                else
                {
                    transaccion.FechaRefencia = fechaReferencia;
                }
            }
        ...
        public async Task<IActionResult> Crear(TransaccionCreacionViewModel modelo)
        {
            ...
            {
                modelo.Cuentas = await ObtenerCuentas(usuarioId);
                var categorias = await repositorioCategorias.Obtener(usuarioId, modelo.TipoOperacionId);
                return View(modelo);
            }
        ...
        public async Task<IActionResult> Editar(TransaccionActualizacionViewModel modelo)
        {
            ...
            var categoria = await repositorioCuentas.ObtenerPorId(modelo.CuentaId, usuarioId);
